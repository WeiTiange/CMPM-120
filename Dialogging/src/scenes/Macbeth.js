class Macbeth extends Phaser.Scene {
    ...
    create() {
        ...
        this.firstWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y+8, 'wanda1').setOrigin(0, 1).setScale(0.3);
        this.secondWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y + 8, 'wanda2').setOrigin(0, 1).setScale(0.3);
        this.thirdWitch = this.add.sprite(this.OFFSCREEN_X, this.DBOX_Y + 8, 'wanda3').setOrigin(0, 1).setScale(0.3);
        this.all = this.add.sprite(this.OFFSCREEN_X-150, this.DBOX_Y + 8).setOrigin(0, 1).setScale(0.3);
